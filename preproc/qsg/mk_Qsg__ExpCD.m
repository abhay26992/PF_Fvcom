...
% Experiments C and D:
% In these experiments (for the thesis), we simply increase the discharge
% value of ExpA (552 m3/s) to mimic RCP scenario increase by 2100.
...
% Here, we distribute it as in Experiment A.

Q_sg=1104; %Exp C: 1104 m3/s (100% gain). Exp D: 1656 m3/s (200% gain).
...
fname='riverNamelist_expC.nml';
fid=fopen(fname,'w+');

riverFile='riverdata_expC.nc';
